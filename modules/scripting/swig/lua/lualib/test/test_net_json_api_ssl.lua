...
loginmod:addPrivilege("aplace", "users", '{"t":"cmd", "n":"connect"}')
loginmod:addPrivilege("aplace", "users", '{"t":"cmd", "n":"disconnect"}')
loginmod:addPrivilege("aplace", "users", '{"t":"cmd", "n":"put"}')
loginmod:addPrivilege("aplace", "users", '{"t":"cmd", "n":"get"}')
loginmod:addPrivilege("aplace", "users", '{"t":"cmd", "n":"start"}')
loginmod:addPrivilege("aplace", "users", '{"t":"cmd", "n":"utxn"}')
loginmod:addPrivilege("aplace", "users", '{"t":"cmd", "n":"ulease"}')
...
------- sock server ---------
net = oescript.OesNet:new(d, true, "cert", "pkey")
net:setName("lua server")
--net = oescript.OesNet:new(d, false, nil, nil)
json = oescript.OesServer:new(d, "oejson://0.0.0.0:5551/aplace", net, store)
assert(json)
json:addLoginModule(loginmod)
json:addKernel("aplace", k)

------- sock client ---------
clnet = oescript.OesNet:new(d, true, nil, nil)
clnet:setName("lua client")
--clnet = oescript.OesNet:new(d, false, nil, nil)
assert(clnet)
c = oescript.OesKernel:new(d, nil, nil, false,
                           "oejson://127.0.0.1:5551/aplace", clnet, username, pwd)
assert(c)
